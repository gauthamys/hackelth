                    ...
                    <div className="text-3xl h-screen mt-4">
                        <div class="text-2xl container py-5 mx-auto flex flex-wrap items-center justify-between">
                            <div class="border-4 border-blue-200 rounded-full bg-white shadow flex w-11/12">
                                ...
                                <button className="relative bg-green-300 rounded-tr-full rounded-br-full transition duration-300 hover:bg-red-300 py-2 px-4 mr-0 w-80">
                                    <p class="text-sm text-gray-500">🔍 search</p>
                                </button>
                            </div>
                        </div>
                        <table class="table-auto w-11/12 text-2xl rounded">
                            ...
                            <tbody className='text-base'>
                                <tr className={'border py-5 px-4 font-semibold '+(this.state.row_data[6] == "Red" ? 'bg-red-300 text-red-900' : 'bg-green-300 text-green-900')}>
